            ...
            {playlists.map((playlist: any, index: number) => (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = '0 8px 24px rgba(29, 185, 84, 0.2)';
                }}
                onMouseLeave={(e) => {
              ...
              >
                <div style={{
                  ...
                  <div style={{
                    ...
                    {(playlist.trackCount !== undefined || (playlist.songs && playlist.songs.length > 0)) && (
                      <span>{playlist.trackCount || playlist.songs.length} songs</span>
                    )}
                    {playlist.isPublic !== undefined && (
                      <span style={{
                        ...
                        color: playlist.isPublic ? '#1DB954' : 'rgba(255, 255, 255, 0.7)',
                        fontSize: '0.75rem',
                        fontWeight: '600'
                      }}>
